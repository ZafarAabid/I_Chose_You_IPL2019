...
public class IPL2019AnalyserTest {
    ...
    IPLAnalyser dataSorting = new IPLAnalyser(new IplBattingDataLoader());
    ...
    public void forGivenTwoCsv_WhenCombinedTheData_IfSortedByStrikeRateWith4w5w_lReturnTrue() {
        ...
        try {
            ...
            List<IplPlayersDAO> bowlersDataList = iplBowlingAnalyzer.loadData(IPL_BOWLING_DATA_CSV_FILE);
            List<IplPlayersDAO> mergedIplData = iplBattingAnalyzer.mergingData(batsmanDataList, bowlersDataList);
            batsmanDataList = dataSorting.sortByParamter(mergedIplData, ComparatorParameters.BowlingParameter.STRIKE_RATE_WITHW4W5);
    ...
    public void forGivenTwoCsv_WhenCombinedTheData_IfSortedByBestBowlingAvgWithStrikeRate_lReturnTrue() {
        ...
        try {
            ...
            List<IplPlayersDAO> bowlersDataList = iplBowlingAnalyzer.loadData(IPL_BOWLING_DATA_CSV_FILE);
            List<IplPlayersDAO> mergedIplData = iplBattingAnalyzer.mergingData(batsmanDataList, bowlersDataList);
            batsmanDataList = dataSorting.sortByParamter(mergedIplData, ComparatorParameters.BowlingParameter.BOWLING_AVG, ComparatorParameters.BowlingParameter.STRIKE_RATE);
    ...
    public void forGivenTwoCsv_WhenCombinedTheData_findAllRounder_lReturnTrue() {
        ...
        try {
            ...
            List<IplPlayersDAO> bowlersDataList = iplBowlingAnalyzer.loadData(IPL_BOWLING_DATA_CSV_FILE);
            List<IplPlayersDAO> mergedIplData = iplBattingAnalyzer.mergingData(batsmanDataList, bowlersDataList);
            batsmanDataList = dataSorting.allRounder(mergedIplData, ComparatorParameters.BowlingParameter.ALL_ROUNDER);
